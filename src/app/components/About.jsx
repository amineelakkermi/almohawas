        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-center gap-16">
          ...
          <div className="flex-1 flex flex-col gap-8 max-w-[600px]">
            ...
            <div className="inline-flex items-center gap-2 border border-blue/10 bg-white px-5 py-2.5 rounded-full w-fit shadow-sm">
              ...
              <span className="text-[14px] text-blue font-medium">عن الشركة</span>
            </div>

            {/* Main Title */}
            <Title as="h2" className={`${styles.title2} text-blue font-bold`}>
              نكرّس خبراتنا لنمنح أعمالكم
              <br className="hidden lg:block" />
              <span className="text-beige">"الحصانة القانونية"</span>
              {" "}التي تستحقها
            </Title>

            {/* Paragraph */}
            <Paragraph
              className={`${styles.paragraph} text-gray-500 leading-[1.9]`}
            >
              نحن في شركة المهوس للمحاماة، لا نكتفي بتقديم الاستشارات؛ بل نصيغ
              الحلول. انطلقنا من قلب المملكة بنخبة من الكفاءات القانونية التي
              تؤمن بأن المحاماة هي فن حماية الحقوق قبل وقوع النزاع، وأمانة الدفاع
              عنها حال وقوعه. نلتزم بالشفافية المطلقة، ونضع نجاحكم كمعيار وحيد
              لتميزنا.
            </Paragraph>
